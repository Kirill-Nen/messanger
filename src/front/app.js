        ...
        class main_controller {
            ...
            async modal_history(chat, parent) {
                ...
                sendBtn.addEventListener('click', async() => {
                    ...
                    socket.emit('new_message', newMessageText, activeChat)
            ...
            drag_drop_init() {
                ...
                document.querySelector('.mainDialog').addEventListener('drop', (e) => {
                    ...
                    if (e.target.classList.contains('mainDialog')) {
                        ...
                        this.modal(activeChat, e.target)
            ...
            search_users() {
                const inp = document.querySelector('#user-search')
